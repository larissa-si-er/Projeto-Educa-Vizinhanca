...
//preloader
if (!isset($_SESSION['preload_displayed'])) {
    $_SESSION['preload_displayed'] = true;
...
<body>   
                    ...
                    <div class="nav-bar">
                        ...
                        <div class="group">
                            ...
                            <form id="searchForm" method="GET" action="">
                                <input name="search" placeholder="Busque aqui seus cursos no site." type="search" class="input" value="<?php echo htmlspecialchars($_GET['search'] ?? '', ENT_QUOTES); ?>">
                            </form>
                        </div>
    ...
    <div class="container-top">
            ...
            <div class="card-top2">
                ...
                <img class="pic-card-tops" src="./img/enfer.jpg" alt="Curso Enfermagem">
                <div class="curso-content content-cardTop">
                    <h2>Curso de Enfermagem</h2>
                    <p>Instituição: Anhanguera
                    Capazes de trabalhar com equipes multidisciplinares.</p>
                </div>
            </div>
            <div class="card-top3">
                <img src="./img/3.png" alt="" srcset="" class="img-top3">
                <img class="pic-card-tops" src="./img/produ.png" alt="Curso Engenharia">
                <div class="curso-content content-cardTop">
                    <h2>Curso de Engenharia</h2>
                    <p>Instituição: EESC USP <br>
                    Curso de engenharia, com foco em diferentes segmentos.</p>
                </div>
            </div>
    </div>
