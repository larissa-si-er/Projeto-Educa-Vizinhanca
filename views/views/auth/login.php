    ...
    <form class="form">
        <div class="flex-column">
          ...
          <div class="inputForm">
            ...
            <input type="text" class="input" placeholder="Digite seu username" maxlength="6">
          </div>
        ...
        <div class="flex-column">
          ...
          <div class="inputForm">
            ...
            <input type="password" class="input" placeholder="Digite sua senha" required maxlength="6" >
          </div>
        ...
        <button class="button-submit" onclick="Alert()">Entrar</button>
