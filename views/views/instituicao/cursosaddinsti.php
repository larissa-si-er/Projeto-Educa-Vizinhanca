...
<div class="voltar">
  ...
  <ul>
    ...
    <a href="areainsti.php" style="display: inline-block; vertical-align: top;">Voltar</a>
  </ul>
  </div>
  </div>
  <br>
<div class="container container-input-search-course">
 <div class="group">
    <i class="fa-solid fa-magnifying-glass" id="search"></i>
    <input placeholder="Busque aqui seus cursos no site." type="search" class="input input-search-course">
  </div>
</div>
<div class="container">
    <div class="card">
